...
class GetMovieByTitleNowPlayingUseCase @Inject constructor(
    private val movieRepository: MovieRepository,
    @IoDispatcher dispatcher: CoroutineDispatcher
): UseCase<String, List<Movie>>(dispatcher) {
    override suspend fun execute(params: String): List<Movie> = movieRepository.getMovieByTitleNowPlaying(params)
}